...
class MoEFusion:
    ...
    def fuse(
        ...
        # Truyền RAW signal_scores vào gating.predict().
        # gating.predict() sẽ tự normalize nội bộ để tính context features
        # (Spearman correlation, confidence) — điều này không ảnh hưởng tới
        # fused_scores bên dưới vì fusion dùng norm_seq/gcn/sem đã normalize ở trên.
