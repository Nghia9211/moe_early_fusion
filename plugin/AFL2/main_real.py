...
def main(args):
    ...
    if args.use_arag:
        ...
        print(f"  Workers:       {args.mp} (ThreadPool, không fork)")
        print("=" * 60)
    else:
        print("=" * 60)
...
if __name__ == '__main__':
    # BẮT BUỘC: guard này ngăn child processes chạy lại toàn bộ
    # module khi dùng multiprocessing trên Windows/macOS (spawn).
    # Trên Linux (fork) vẫn cần để tránh lỗi khi dùng CUDA.
