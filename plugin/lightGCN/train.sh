...
# --- 2. PHASE TRAINING ---
# Hyperparameters theo paper gốc LightGCN (He et al., SIGIR 2020):
#   - epochs=1000  : paper train đủ 1000 epochs
#   - lr=0.001     : Adam optimizer, learning rate chuẩn của paper
#   - reg=1e-4     : L2 regularization lambda, paper ablation study chọn 1e-4
#   - emb_dim=64   : embedding dimension chuẩn của paper
#   - num_layers=3 : paper thực nghiệm K=1..4, K=3 cho kết quả tốt nhất trên hầu hết dataset
