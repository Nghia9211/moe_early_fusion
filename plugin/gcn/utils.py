...
def plot_loss(loss_history, reg_history, dataset):
    # Ensure output directory exists (Linux-friendly path)
    out_dir = "trainingLoss"
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, f'{dataset}_training_loss.png')) 
    plt.close()